...
<i>Try it on the static calculator with `?estate=24&husband=1&wife=0&son=0&daughter=0&father=0&mother=0&brother=0&sister=2&relatives=0`.</i>
...
* The 'Heritage (Fiqh)' values are calculated locally using the Fiqh rules supported by this calculator.
