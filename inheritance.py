...
class Amounts:
    ...
    def get_dict(self):
        ...
        d = {HOIH.HUSBAND.name: [f"{get_fraction(amounts.husband)}: {heirs.husband}x{f_amount(amounts.husband):.{PRECISION_DISPLAY}f} (+{float(self._radd.husband):.{PRECISION_DISPLAY}f})"], HOIH.WIFE.name: [f"{get_fraction(amounts.wife)}: {heirs.wife}x{f_amount(amounts.wife):.{PRECISION_DISPLAY}f} (+{float(self._radd.wife):.{PRECISION_DISPLAY}f})"], HOIH.SON.name: [f"{get_fraction(amounts.son)}: {heirs.son}x{one_heir_amount('son'):.{PRECISION_DISPLAY}f} (+{float(self._radd.son):.{PRECISION_DISPLAY}f})"], HOIH.DAUGHTER.name: [f"{get_fraction(amounts.daughter)}: {heirs.daughter}x{one_heir_amount('daughter'):.{PRECISION_DISPLAY}f} (+{float(self._radd.daughter):.{PRECISION_DISPLAY}f})"], HOIH.BROTHER.name: [f"{get_fraction(amounts.brother)}: {heirs.brother}x{one_heir_amount('brother'):.{PRECISION_DISPLAY}f} (+{float(self._radd.brother):.{PRECISION_DISPLAY}f})"], HOIH.SISTER.name: [f"{get_fraction(amounts.sister)}: {heirs.sister}x{one_heir_amount('sister'):.{PRECISION_DISPLAY}f} (+{float(self._radd.sister):.{PRECISION_DISPLAY}f})"], HOIH.FATHER.name: [f"{get_fraction(amounts.father)}: {heirs.father}x{f_amount(amounts.father):.{PRECISION_DISPLAY}f} (+{float(self._radd.father):.{PRECISION_DISPLAY}f})"], HOIH.MOTHER.name: [f"{get_fraction(amounts.mother)}: {heirs.mother}x{f_amount(amounts.mother):.{PRECISION_DISPLAY}f} (+{float(self._radd.mother):.{PRECISION_DISPLAY}f})"], HOIH.RELATIVES.name: [f"{get_fraction(amounts.relatives)}: {heirs.relatives}x{one_heir_amount('relatives'):.{PRECISION_DISPLAY}f} (+{float(self._radd.relatives):.{PRECISION_DISPLAY}f})"]}
